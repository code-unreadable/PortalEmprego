...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220706_empregosemsc_a82c6735ade0fe5e3407_20220706165722_archive.zip';
	const ARCHIVE_SIZE		 = '70193130';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'a82c673-06165722';
    const SECONDARY_PACKAGE_HASH = '69f258d-06165722';
	const VERSION			 = '1.4.7';
